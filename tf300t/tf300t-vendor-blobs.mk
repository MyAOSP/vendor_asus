...
PRODUCT_COPY_FILES += \
    ...
    vendor/asus/tf300t/proprietary/lib/libavcodec.so:system/lib/libavcodec.so \
    vendor/asus/tf300t/proprietary/lib/libavutil.so:system/lib/libavutil.so \
    vendor/asus/tf300t/proprietary/lib/libcgdrv.so:system/lib/libcgdrv.so \
    vendor/asus/tf300t/proprietary/lib/libiris-jni.so:system/lib/libiris-jni.so \
    vendor/asus/tf300t/proprietary/lib/libjingle.so:system/lib/libjingle.so \
    ...
    vendor/asus/tf300t/proprietary/lib/libortp.so:system/lib/libortp.so \
    vendor/asus/tf300t/proprietary/lib/libpolarisoffice_Clipboard.so:system/lib/libpolarisoffice_Clipboard.so \
    vendor/asus/tf300t/proprietary/lib/libpolarisoffice.so:system/lib/libpolarisoffice.so \
    vendor/asus/tf300t/proprietary/lib/libstagefrighthw.so:system/lib/libstagefrighthw.so \
    vendor/asus/tf300t/proprietary/lib/libswscale.so:system/lib/libswscale.so \
